...
estimators = [20,50,70,100,120,150,180,200]
est_scores = []
for est in estimators:
    rf = ensemble.RandomForestClassifier(n_estimators=est, max_depth=5, 
                                         min_samples_leaf=4, n_jobs = -1, oob_score =True, 
                                         max_features='auto', random_state=0, class_weight='balanced_subsample')
    est_scores.append(cv_score(rf,x_train,y_train))
...
np.savetxt('rf_tree_20_200_8.txt', est_scores, delimiter=',')
#print(tree_scores)
'''
